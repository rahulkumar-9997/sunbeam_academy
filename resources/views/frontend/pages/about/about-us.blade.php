...
@section('title','Sunbeam Academy Varanasi CBSE School Campus | About Us')
@section('description', 'Explore About Us at Sunbeam Academy Varanasi, covering academics, activities, facilities, and student development.')
