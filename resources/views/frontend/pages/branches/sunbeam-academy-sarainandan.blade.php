...
@section('title','Sunbeam Academy Sarainandan | CBSE School in Varanasi')
@section('description', 'Find details on Sunbeam Academy Sarainandan at Sunbeam Academy Varanasi, covering academics, activities, facilities, and student development.')
<!-- @section('keywords', 'Sunbeam Academy, Samneghat Varanasi, Experienced Teachers, Global Perspective,Technology Perspective') -->
@section('main-content')
<!--===== HERO AREA STARTS =======-->
<div class="hero1-section-area sarainandan-hero">
	<div class="bg1">
			...
			<div class="col-lg-6">
				<div class="hero1-header heading1 wow fadeInLeft" data-wow-delay=".25s">
					...
					<h1 class="text-anime-style-3">
						Welcome to Sunbeam Academy <span>Sarainandan.</span>
					</h1>
			...
			<div class="col-lg-6">
				...
				<div class="team-details">
					<div class="row align-items-center">
						...
						<div class="col-md-8">
							<h3>Principal’s</h3>
							<strong>Mr. Sanjeev Kumar Jha</strong>
							<p class="mt-3">
		...
		<div class="row align-items-center">
			<div class="col-lg-6 col-md-6">
				<div class="tour-title wow fadeInLeft   animated" data-animation="fadeInLeft" data-delay=".4s" style="visibility: visible; animation-name: fadeInLeft;">
					<h3>Sunbeam Academy Sarainandan</h3>
				</div>
				<div class="tour-details">
					<p>
						Sunbeam Academy – Sarainandan is known for its commitment to academic excellence, holistic development, and innovative learning environments. With over a decade of nurturing young minds, our campus stands as a beacon of progressive education in the region.
					</p>
				</div>
			</div>
			<div class="col-lg-6 col-md-6">
