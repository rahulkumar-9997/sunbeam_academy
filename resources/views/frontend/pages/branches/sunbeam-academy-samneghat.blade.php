			...
			<div class="col-lg-6">
				<div class="hero1-header heading1 wow fadeInLeft" data-wow-delay=".25s">
					...
					<p data-aos="fade-left" data-aos-duration="900">
						Nurturing Young Minds in the Heart of Downtown.
					</p>
					<div class="branches-head-con">
						<ul>
                             ...
                             <li>
                                 <a href="tel:+919554958414"><i class="far fa-phone-volume"></i> +91 9554958414</a>
                             </li>
                         </ul>
					</div>
		...
		<div class="row align-items-center">
			<div class="col-md-4">
				<div class="team-single-img">
					<img src="{{asset('fronted/assets/sunbeam-img/team/secretary-1.jpg')}}" class="w100" alt="">
				</div>
			</div>
			<div class="col-md-8">
