...
@section('title','Sunbeam Academy Durgakund | CBSE School in Varanasi')
@section('description', 'Learn about Sunbeam Academy Durgakund at Sunbeam Academy Varanasi, covering academics, activities, facilities, and student development.')
...
<div class="hero1-section-area durgakund-hero">
	<div class="bg1">
		<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/header-bg2.png')}}" alt="" class="header-bg1" loading="lazy" decoding="async"/>
	</div>
	<div class="container">
					...
					<div class="row align-items-center">
						<div class="col-md-4">
							<div class="team-single-img text-center branches-img-div">
								<img src="{{asset('fronted/assets/sunbeam-img/noperson-female.png')}}" class="" alt="principal" loading="lazy" decoding="async">
							</div>
						</div>
		...
		<div class="row g-4">
			<div class="col-md-6 col-lg-3">
				<div class="feature-item wow fadeInUp" data-wow-delay=".25s">
					...
					<div class="feature-icon">
						<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/icon/established.png')}}" alt="icon" loading="lazy" decoding="async">
					</div>
			...
			<div class="col-md-6 col-lg-3">
				<div class="feature-item active wow fadeInDown" data-wow-delay=".25s">
					...
					<div class="feature-icon">
						<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/icon/grades.png')}}" alt="icon" loading="lazy" decoding="async">
					</div>
					<div class="feature-content">
			...
			<div class="col-md-6 col-lg-3">
				<div class="feature-item wow fadeInUp" data-wow-delay=".25s">
					...
					<div class="feature-icon">
						<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/icon/40-classrooms.png')}}" alt="icon" loading="lazy" decoding="async">
					</div>
					<div class="feature-content">
			...
			<div class="col-md-6 col-lg-3">
				<div class="feature-item wow fadeInDown" data-wow-delay=".25s">
					...
					<div class="feature-icon">
						<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/icon/award-winning-faculty.png')}}" alt="icon" loading="lazy" decoding="async">
					</div>
					<div class="feature-content">
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-6">
				<div class="step-img wow fadeInLeft  animated" data-animation="fadeInLeft" data-delay=".4s">
					<img src="{{asset('fronted/assets/sunbeam-img/branches/samneghat/samneghat.jpg')}}" alt="class image" class="w100" loading="lazy" decoding="async">
				</div>
			</div>
		</div>
					...
					<div class="testimonial-content">
						<div class="testimonial-author-img">
							@if($alumni->profile_pic)
								<img src="{{ asset('upload/alumni/' . $alumni->profile_pic) }}" alt="{{ $alumni->title }}" loading="lazy" decoding="async">
							@else
								<img src="{{asset('fronted/assets/img/testimonial/01.jpg')}}" alt="{{ $alumni->title }}" loading="lazy" decoding="async">
							@endif
						</div>
